(function () {
  ...
  function renderPublications(publications) {
    ...
    publications.forEach((item) => {
      ...
      // Prefer a local PDF when available, otherwise use external journal/conference link.
      ...
      // Optional explicit external link if it's different from the primary URL.
      if (externalUrl && externalUrl !== primaryUrl) {
        const sep = document.createElement("span");
        sep.className = "meta";
        sep.textContent = "  |  ";
        card.appendChild(sep);
        appendPaperLink(card, externalUrl, "Journal/Proceedings link");
        hasAnyLink = true;
      }
